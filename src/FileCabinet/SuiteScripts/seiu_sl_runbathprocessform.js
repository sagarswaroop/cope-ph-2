  ...
  function onRequest(context) {
    ...
    function execute() {
      ...
      transactionSearchObj.run().each(function (result) {
        ...
        //   return true;
        // }
        getRusltBasedonDate(bankRecDate,achQualRecords,achNonQualRecords,wireQalRecords,wireNonQalRecords,checkQualRecords,checkNonQualRecords,holdRecord);
     ...
     */
      ...
      function getRusltBasedonDate(date,achQualRecords,achNonQualRecords,wireQalRecords,wireNonQalRecords,checkQualRecords,checkNonQualRecords,holdRecord) {
        ...
        transactionSearchObj.run().each(function (result) {
          ...
          if (searchResultCount > 0) {
            ...
            dataMap(copeObjects,achQualRecords,achNonQualRecords,wireQalRecords,wireNonQalRecords,checkQualRecords,checkNonQualRecords,holdRecord);
          }
      ...
      function dataMap(searchResult,achQualRecords,achNonQualRecords,wireQalRecords,wireNonQalRecords,checkQualRecords,checkNonQualRecords,holdRecord) {
            ...
            if (method == transmittalpaymentMethods.ach) {
              ...
              achNonQualRecords.line.push({
                ...
                lineMemo: "Contribution | " +
                  ...
                  searchResult.BankRecDate +
                  " | ACH",
                adjustAmount: parseFloat(searchResult.localNonQualiyingFund) -
              ...
              wireNonQalRecords.line.push({
                ...
                lineMemo: "Contribution | " +
                  ...
                  searchResult.BankRecDate +
                  " | WIRE",
                adjustAmount: searchResult.localNonQualiyingFund -
                  searchResult.seiuNonQualiyingFund,
                  year:searchResult.year
              });
